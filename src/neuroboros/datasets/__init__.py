...
class Raiders(Dataset):
    ...
    This dataset contains fMRI responses while participants passively
    viewed the second half of the audiovisual movie *Raiders of the
    Lost Ark* (1981).
    ...
    References
    ----------
    https://www.proquest.com/dissertations-theses/geometry-observed-action-representation-during/docview/2018905893/se-2
